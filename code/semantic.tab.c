...
{
       0,    68,    68,    76,    77,    82,    81,   105,   107,   124,
     143,   146,   148,   152,   153,   162,   161,   170,   177,   186,
     188,   192,   193,   194,   195,   196,   197,   198,   203,   207,
     202,   218,   220,   225,   224,   231,   234,   242,   250,   252,
     257,   266,   256,   276,   285,   289,   301,   302,   310,   311,
     317,   318,   330,   335,   340,   343,   349,   348,   370,   372,
     380,   390,   391,   395,   399,   407,   415
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$@1", "parameter", "body", "variable_list", "variable", "pocetak_var",
  "$@2", "vars", "statement_list", "statement", "jiro_statement", "$@3",
  "$@4", "break_exp", "tranga_exp", "$@5", "jiro_literal", "toerana_exp",
  "para_statement", "$@6", "$@7", "postinc_statement",
  "compound_statement", "assignment_statement", "num_exp", "exp",
  "literal", "function_call", "$@8", "argument", "if_statement", "if_part",
...
{
      10,    25,    17,    10,   -58,   -58,   -58,   -58,    28,    41,
      35,    -6,   -58,    40,    55,   -58,   -58,    54,    67,   -58,
     -58,   -58,    15,     2,    71,    39,   -58,    69,    56,   -12,
     -58,   -58,    70,   -58,   -58,   -58,   -58,   -58,   -58,   -58,
     -58,    76,   -58,   -58,    65,    -9,   -58,   -58,    39,     4,
     -58,   -58,    63,    39,   -58,    20,    39,    72,    21,    81,
      75,    33,    79,   -58,    78,     5,   -58,    39,   -58,    34,
      80,   -58,    52,   -58,   -58,    82,    83,   -58,   -58,    39,
     -58,   -58,    39,    33,   -58,   -58,   -58,    77,     0,    77,
     -58,    84,    85,   -58,    39,    39,    86,    77,    87,    74,
      73,    64,    51,    68,   -58,   -58,   -58,    64,    88,    90,
     -58,    89,    91,    33,   -58,    93,    33,    33,   -58,    33,
      66,    66,   -58,    92,   -58,   -58,   -58
};
...
{
       0,     0,     0,     2,     3,     5,     1,     4,     0,     7,
       0,     0,     8,     0,     0,    11,     6,     0,    19,     9,
      15,    12,     0,     0,     0,     0,    13,     0,     0,     0,
      19,    10,     0,    28,    20,    27,    26,    24,    21,    22,
      23,    61,    25,    17,    16,    49,    54,    55,     0,     0,
      46,    48,    50,     0,    66,     0,     0,     0,     0,     0,
       0,     0,     0,    51,     0,     0,    14,     0,    52,     0,
       0,    65,     0,    43,    44,     0,     0,    62,    18,    58,
      53,    47,     0,     0,    45,    40,    29,    59,     0,    64,
      63,     0,     0,    57,     0,     0,     0,    60,     0,     0,
       0,     0,    38,     0,    36,    37,    33,     0,     0,     0,
      41,     0,     0,     0,    30,     0,     0,     0,    39,     0,
      31,    31,    42,     0,    34,    35,    32
};
...
{
     -58,   -58,   -58,    97,   -58,   -58,   -58,   -58,   -58,   -58,
     -58,   -58,    94,   -57,   -58,   -58,   -58,   -26,   -58,   -58,
      -2,   -58,   -58,   -58,   -58,   -58,   -58,   -58,   -25,    42,
       3,   -58,   -58,   -58,   -58,   -58,     6,   -58
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     4,     8,    11,    16,    18,    21,    22,
      24,    44,    23,    34,    35,    60,    92,   124,   102,   111,
     106,   109,    36,    91,   115,    37,    38,    39,    69,    50,
      51,    52,    64,    88,    40,    41,    70,    42
};
...
{
      49,   -56,    56,    55,    77,    13,    27,    57,    28,    29,
      63,    93,    14,     1,    30,    31,    80,     6,    94,    66,
      67,    67,    32,    65,    33,    27,    90,    28,    29,    25,
      26,    72,     5,    30,    74,    71,    67,    27,     9,    28,
      29,    32,    12,    33,    10,    30,    45,    46,    47,    48,
      67,    82,    15,    32,    87,    33,   118,    89,    17,   120,
     121,    19,   122,    45,    46,    47,    48,    84,    67,    97,
      20,    54,   104,   105,   107,   108,    46,    47,    43,    53,
      59,    61,    68,    62,    75,    76,    78,    73,    79,    85,
      86,    83,   123,    67,   103,   125,    96,   101,    99,    95,
       7,    98,   100,   114,   119,   112,   110,   126,     0,    81,
       0,     0,     0,   113,   116,     0,   117,     0,     0,     0,
       0,     0,     0,     0,    58
};

static const yytype_int8 yycheck[] =
{
      25,    10,    14,    28,    61,    11,     4,    19,     6,     7,
      19,    11,    18,     3,    12,    13,    11,     0,    18,    15,
      16,    16,    20,    48,    22,     4,    83,     6,     7,    14,
      15,    56,     7,    12,    13,    15,    16,     4,    10,     6,
       7,    20,     7,    22,     3,    12,     7,     8,     9,    10,
      16,    17,    12,    20,    79,    22,   113,    82,     3,   116,
     117,     7,   119,     7,     8,     9,    10,    15,    16,    94,
       3,    15,     8,     9,    23,    24,     8,     9,     7,    10,
      10,     5,    19,    18,     3,    10,     7,    15,    10,     7,
       7,    11,    26,    16,    21,   121,    11,    23,    12,    15,
       3,    95,    15,    13,    11,   107,   103,    15,    -1,    67,
      -1,    -1,    -1,    25,    25,    -1,    25,    -1,    -1,    -1,
      -1,    -1,    -1,    -1,    30
};
...
static const yytype_uint8 yystos[] =
{
       ...
       3,    33,     7,    11,    18,    12,    34,     3,    35,     7,
       3,    36,    37,    40,    38,    14,    15,     4,     6,     7,
      12,    13,    20,    22,    41,    42,    50,    53,    54,    55,
      62,    63,    65,     7,    39,     7,     8,     9,    10,    56,
      57,    58,    59,    10,    15,    56,    14,    19,    40,    10,
      43,     5,    18,    19,    60,    56,    15,    16,    19,    56,
      64,    15,    56,    15,    13,     3,    10,    41,     7,    10,
      11,    57,    17,    11,    15,     7,     7,    56,    61,    56,
      41,    51,    44,    11,    18,    15,    11,    56,    64,    12,
      15,    23,    46,    21,     8,     9,    48,    23,    24,    49,
      58,    47,    48,    25,    13,    52,    25,    25,    41,    11,
      41,    41,    41,    26,    45,    45,    15
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      34,    35,    35,    36,    36,    38,    37,    39,    39,    40,
      40,    41,    41,    41,    41,    41,    41,    41,    43,    44,
      42,    45,    45,    47,    46,    46,    48,    48,    49,    49,
      51,    52,    50,    53,    54,    55,    56,    56,    57,    57,
...
static const yytype_uint8 yyr2[] =
{
       ...
       4,     0,     2,     2,     4,     0,     3,     1,     3,     0,
       2,     1,     1,     1,     1,     1,     1,     1,     0,     0,
      10,     0,     2,     0,     6,     6,     1,     1,     0,     3,
       0,     0,    13,     3,     3,     4,     1,     3,     1,     1,
       1,     2,     2,     3,     1,     1,     0,     5,     0,     1,
       3,     1,     3,     5,     3,     3,     2
};
...
#line 207 "semantic.y" /* yacc.c:1646  */
    ...
    tip=get_type(lookup_symbol((yyvsp[0].s),VAR|PAR));
  }
...
#line 257 "semantic.y" /* yacc.c:1646  */
    {
     int ind=lookup_symbol((yyvsp[0].s),ITR);
     if(ind==NO_INDEX)
      insert_symbol((yyvsp[0].s),ITR,(yyvsp[-1].i),NO_ATR,NO_ATR);
...
#line 277 "semantic.y" /* yacc.c:1646  */
    {
    if((lookup_symbol((yyvsp[-2].s), VAR|PAR|ITR)) == NO_INDEX)          
...
#line 312 "semantic.y" /* yacc.c:1646  */
    {
        (yyval.i) = lookup_symbol((yyvsp[0].s), VAR|PAR|ITR);
        if((yyval.i) == NO_INDEX)
...
#line 319 "semantic.y" /* yacc.c:1646  */
    {
      ...
      {
        vrsta = get_kind(lookup_symbol((yyvsp[-1].s), VAR|PAR));
...
#line 423 "semantic.y" /* yacc.c:1906  */
